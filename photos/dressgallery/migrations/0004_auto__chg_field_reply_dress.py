...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Reply.dress'
        db.alter_column('dressgallery_reply', 'dress_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['dressgallery.Dress']))
    ...
    models = {
        ...
        'dressgallery.reply': {
            ...
            'dress': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dressgallery.Dress']", 'null': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
