...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CatalogCategoryModel'
        db.create_table('catalog_catalogcategorymodel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('full_name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['catalog.CatalogCategoryModel'])),
            ('orderindex', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('catalog', ['CatalogCategoryModel'])

        # Adding model 'CatalogItemModel'
        db.create_table('catalog_catalogitemmodel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', to=orm['catalog.CatalogCategoryModel'])),
            ...
            ('chemical', self.gf('django.db.models.fields.TextField')()),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['filer.Image'], null=True, blank=True)),
            ('description_image', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='description_image+', null=True, blank=True, to=orm['filer.Image'])),
            ('orderindex', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('show_on_main_page', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('catalog', ['CatalogItemModel'])


    def backwards(self, orm):
        # Deleting model 'CatalogCategoryModel'
        db.delete_table('catalog_catalogcategorymodel')

        # Deleting model 'CatalogItemModel'
        db.delete_table('catalog_catalogitemmodel')
