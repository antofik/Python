...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CatalogItemModel.active_substance'
        db.add_column('catalog_catalogitemmodel', 'active_substance',
                      self.gf('django.db.models.fields.CharField')(default=u'\u0434.\u043e.', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CatalogItemModel.active_substance'
        db.delete_column('catalog_catalogitemmodel', 'active_substance')
