...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CatalogVideoModel'
        db.create_table('catalog_catalogvideomodel', (
            ...
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='catalog_video_image+', null=True, to=orm['filer.Image'])),
        ))
        db.send_create_signal('catalog', ['CatalogVideoModel'])

        # Adding M2M table for field items on 'CatalogVideoModel'
        db.create_table('CatalogItemVideoModel', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('catalogvideomodel', models.ForeignKey(orm['catalog.catalogvideomodel'], null=False)),
            ('catalogitemmodel', models.ForeignKey(orm['catalog.catalogitemmodel'], null=False))
        ))
        db.create_unique('CatalogItemVideoModel', ['catalogvideomodel_id', 'catalogitemmodel_id'])


    def backwards(self, orm):
        # Deleting model 'CatalogVideoModel'
        db.delete_table('catalog_catalogvideomodel')

        # Removing M2M table for field items on 'CatalogVideoModel'
        db.delete_table('CatalogItemVideoModel')
    ...
    models = {
        ...
        'catalog.catalogvideomodel': {
            ...
            'items': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'videos'", 'symmetrical': 'False', 'db_table': "'CatalogItemVideoModel'", 'to': "orm['catalog.CatalogItemModel']"}),
