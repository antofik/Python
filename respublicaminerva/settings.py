# Django settings for respublicaminerva.ru project.
import os
...
SECRET_KEY = 'b8lv5fbsu8-_67=ibk1&amp;_(zq%(auswx#(2)ss-2o_y8&amp;b=07cf'
...
EMAIL_HOST_USER = 'no-reply@fabricartis.ru'
EMAIL_HOST_PASSWORD = 'q5>h9VLF'
EMAIL_PORT = 587
