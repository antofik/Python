...
DATABASES = {
    'default': {
        ...
        'NAME': 'db.lite',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '@#hju^5wjpd*(%yrifeh$u@qclqm#g^^hcq%5sf73$s7mk5768'
...
ROOT_URLCONF = 'TestArea.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'TestArea.wsgi.application'
