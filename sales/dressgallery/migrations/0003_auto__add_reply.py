...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Reply'
        db.create_table('dressgallery_reply', (
            ...
            ('email_delivered', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('sms_delivered', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('dressgallery', ['Reply'])


    def backwards(self, orm):
        # Deleting model 'Reply'
        db.delete_table('dressgallery_reply')
